...
export default function ExitObserveScreen({ symptom, tree, path, onBack, onRestart }) {
  return (
    <div className="screen-enter">
      ...
      <div style={{ background: C.hintInfoBg, border: `1px solid ${C.hintInfoBorder}`, color: C.hintInfoColor, fontSize: 13, padding: "10px 14px", borderRadius: 4, marginBottom: 24, lineHeight: 1.5 }}>
